...
export function UsersPermissionsRolesGet200ResponseFromJSONTyped(
  ...
  return {
    roles: !exists(json, 'roles')
      ? undefined
      : (json['roles'] as Array<any>).map(UsersPermissionsRolesGet200ResponseRolesInnerFromJSON),
  };
}
  ...
  return {
    roles:
      value.roles === undefined
        ? undefined
        : (value.roles as Array<any>).map(UsersPermissionsRolesGet200ResponseRolesInnerToJSON),
  };
}
