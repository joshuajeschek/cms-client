...
export function AuthForgotPasswordPost200ResponseFromJSON(
  json: any
): AuthForgotPasswordPost200Response {
  return AuthForgotPasswordPost200ResponseFromJSONTyped(json, false);
}

export function AuthForgotPasswordPost200ResponseFromJSONTyped(
  json: any,
...
export function AuthForgotPasswordPost200ResponseToJSON(
  value?: AuthForgotPasswordPost200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
